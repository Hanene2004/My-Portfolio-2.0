  ...
  return (
    <>
      <div>
        ...
        >
          <button
            onClick={() => window.open("https://github.com/Hanene2004", "_blank")}
            className="group relative inline-flex items-center gap-3 px-8 py-4 bg-[#0a0e17] border border-white/[0.08] hover:border-blue-500/50 rounded-xl transition-all duration-400 shadow-[0_4px_20px_rgba(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgba(59,130,246,0.15)] overflow-hidden"
          >
            {/* Background Glow */}
            ...
            />
            <span className="text-white font-semibold text-lg tracking-tight group-hover:text-blue-50 transition-colors duration-300">
              Explore more than 30+ projects on my GitHub
            </span>
