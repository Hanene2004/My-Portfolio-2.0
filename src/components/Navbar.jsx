...
const NAV_LINKS = [
  ...
  },
  {
    title: "education",
    href: "#education",
    img: "/assets/nav-link-previews/education.png",
  },
  {
    title: "project",
    href: "#projects",
  ...
  },
  {
    title: "soft skills",
    href: "#soft-skills",
    img: "/assets/nav-link-previews/soft-skills.png",
  },
  {
    title: "achievements",
    href: "#achievements",
...
const Navbar = () => {
  ...
  return (
    <motion.header
      className={`z-30 fixed top-0 left-0 w-full transition-colors duration-500 ease-in  ${scrolled ? "backdrop-blur-xl border-b border-white/5" : ""
        } `}
      style={{
    ...
    >
      ...
      <motion.div
        className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-cyan-500 via-indigo-500 to-purple-500 origin-left z-[100]"
        style={{ scaleX }}
      />
            ...
            >
              <div className="flex flex-wrap items-start gap-1 w-2/3 pl-8">
                {NAV_LINKS.map((link, idx) => (
                  <Magnetic key={link.title} strength={0.3} radius={100}>
                    <a
                      href={link.href}
                      className="group cursor-pointer rounded-lg px-3 py-2 text-3xl sm:text-5xl md:text-7xl font-extrabold uppercase transition-all duration-200 whitespace-nowrap text-left relative inline-block"
